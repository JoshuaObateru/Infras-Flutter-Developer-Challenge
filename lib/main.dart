...
import 'package:infras_flutter_developer_challenge/core/widgets/bottom_navigation.dart';
...
import 'package:infras_flutter_developer_challenge/injector.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        BlocProvider(create: (context) => sl<AddExpenseBloc>()),
        BlocProvider(
          create: (context) => sl<GetExpensesBloc>(),
        ),
        BlocProvider(
          create: (context) => sl<GetMoviesBloc>(),
        ),
      ],
      child: MaterialApp(
        title: 'Flutter Demo',
